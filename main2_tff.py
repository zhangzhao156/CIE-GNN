...
from models2.CausalGCN import GCNNet, GATNet, GINNet,GraphSage,ChebyNet,HoGCN,SGCN
...
if __name__ == '__main__':
    ...
    # numlasses = TEgraph.num_classes
    numlasses = TFFgraph.num_classes
    if args.model_name == "GCN":
        model = GCNNet(num_features=feature, num_classes=numlasses, args=args).to(device)
    elif args.model_name == "GIN":
        model = GINNet(num_features=feature, num_classes=numlasses, args=args).to(device)
    elif args.model_name == "GAT":
        model = GATNet(num_features=feature, num_classes=numlasses, args=args).to(device)
